(function () {
  ...
  function renderLayout(config) {
    return [
      ...
      '<span class="sdpi-segmented-content"><span class="sdpi-segmented-label">실시간</span><span class="sdpi-segmented-description">50ms 최신값 병합</span><span class="sdpi-segment-indicator" aria-hidden="true">✓ 선택됨</span></span>',
      "</label>",
      ...
      '<span class="sdpi-segmented-content"><span class="sdpi-segmented-label">스로틀링</span><span class="sdpi-segmented-description">선택한 간격마다 최신값 반영</span><span class="sdpi-segment-indicator" aria-hidden="true">✓ 선택됨</span></span>',
      "</label>",
      "</div>",
