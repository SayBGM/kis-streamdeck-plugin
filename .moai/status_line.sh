...
if [ -f "/Users/backgwangmin/go/bin/moai" ]; then
	exec "/Users/backgwangmin/go/bin/moai" statusline < "$temp_file"
fi

# Try user local bin directory
if [ -f "/Users/backgwangmin/.local/bin/moai" ]; then
	exec "/Users/backgwangmin/.local/bin/moai" statusline < "$temp_file"
fi
